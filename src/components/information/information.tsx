    ...
    return <>
        <div className="w-full px-20 py-10">
            <h1 className="text-4xl font-bold text-center">
                <span className=" border-orange-500 border-b-4 px-4">Why this project?</span>
            </h1>
            <div className="mt-10">
                <p>
            ...
            <div className="text-sm p-10 w-3/6 mx-auto my-10 text-justify italic rounded shadow-xl overflow-hidden transition duration-200 transorm hover:scale-105 border border-gray-200">
                <p className="py-2 text-center text-lg not-italic    ">
                    Problem
                </p>
                <p className="py-2">
