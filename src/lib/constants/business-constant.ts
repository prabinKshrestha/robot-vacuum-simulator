...
export const ROBOT_CLEAN_TIME_SEC_PER_CELL_DEFAULT: number = 0.5;

export const NUMBER_OF_ROBOTS_MINIMUM: number = 1;
export const NUMBER_OF_ROBOTS_MAXIMUM: number = 10;
